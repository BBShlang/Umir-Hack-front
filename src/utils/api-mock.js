 ...
 * 
 * ⚠️ ВНИМАНИЕ: Этот файл НЕ используется в текущей версии проекта.
 * Все запросы идут через реальный API (api.js).
 * 
 * Этот файл оставлен для истории и возможного будущего использования
 * при разработке без бэкенда.
 * 
 * Чтобы использовать mock API:
 * 1. Замените импорты '../api/api.js' на '../utils/api-mock.js' в composables
 * 2. НЕ используйте в production!
 */
